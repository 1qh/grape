...
export default function SelectorManager({
  ...
  return (
    <div className='gjs-custom-selector-manager p-2 flex flex-col gap-2 text-left'>
      ...
      <div className='flex items-center gap-2 flex-wrap p-2 bg-black/30 border rounded min-h-[45px]'>
        {targetStr ? (
          <button type='button' onClick={addNewSelector} className={cn('border rounded px-2 py-1')}>
        ...
        {selectors.map(selector => (
          <div
            ...
            className='px-2 py-1 flex items-center gap-1 whitespace-nowrap bg-stone-500 rounded'>
