...
export type AssetManagerProps = Pick<AssetsResultProps, 'assets' | 'close' | 'select'>

export default function AssetManager({ assets, select }: AssetManagerProps) {
  const editor = useEditor()
  const remove = (asset: Asset) => editor.Assets.remove(asset)
